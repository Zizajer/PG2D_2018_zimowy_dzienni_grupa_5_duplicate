...
namespace Dungeon_Crawler
{
    ...
    {
        public BossLevel(Map map, Grid grid, int cellSize, List<Character> enemies, List<Item> items, Texture2D floor, Texture2D wall, Portal portal, List<Cell> occupiedCells)
        {
            this.map = map;
            this.grid = grid;
