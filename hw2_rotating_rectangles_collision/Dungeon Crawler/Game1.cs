...
{    
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            personPosition.X = 180;
            personPosition.Y = 200;

            blocks.Add(new Block(new Vector2(100, 100), 0.002f));
            blocks.Add(new Block(new Vector2(80, 300), 300));
            blocks.Add(new Block(new Vector2(200, 400), 500));
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(font, "X= "+personPosition.X + " Y=" + personPosition.Y + " " +collision, new Vector2(400, 100), Color.Black);
